...
class _UserNavState extends State<UserNav> with SingleTickerProviderStateMixin {
        ...
        child: TabBar(
          ...
          tabs: [
            ...
            Padding(
              ...
              child: Tab(icon: Icon(Icons.recycling,color: white,)),
            ),
         
             Tab(icon: Icon(Icons.notifications,color: white,)),
          ],
        ),
        fit: StackFit.expand,
